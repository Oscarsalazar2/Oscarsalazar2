...
Busco seguir aprendiendo y aplicar mis conocimientos en proyectos académicos y reales  
Instituto Tecnológico de Matamoros (TECNM)
...
🔹 **Desarrollo de diversas páginas web**  
Creación de aplicaciones web con enfoque académico y funcional.  
Tecnologías: HTML, CSS, JavaScript, Laravel, React y PostgreSQL.

🔹 **Estación Meteorológica IoT**  
Sistema para monitoreo ambiental mediante sensores y comunicación inalámbrica.  
Tecnologías: ESP32, LoRa y visualización de datos en tiempo real.

🔹 **Mapeo Solar**  
Proyecto orientado al análisis y visualización de datos geográficos.  
Uso de mapas interactivos y herramientas de geolocalización.
